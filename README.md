...
* [Parse Server](https://parseplatform.org/) - Parse Server is an open source version of the Parse backend that can be deployed to any infrastructure that can run Node.js. You can find the source on the [GitHub repo](https://github.com/parse-community/parse-server) ⭐ 21,408 | 🐛 552 | 🌐 JavaScript | 📅 2026-08-07.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 36 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-20 - Serverless agentic AI operating system (h9y.ai). Open-source, self-hosted/cloud, omni-channel, decentralized, extensible.
...
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,729 | 🐛 538 | 🌐 Python | 📅 2026-08-20 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,562 | 🐛 126 | 🌐 Python | 📅 2026-08-18
...
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function) ⭐ 1,066 | 🐛 14 | 🌐 Java | 📅 2026-08-20 - Java framework for doing Functions using Spring ecosystem.
...
* [LambCI](https://github.com/lambci/lambci) ⭐ 3,962 | 🐛 41 | 🌐 Shell | 📅 2024-04-23 - A continuous integration system built on AWS Lambda
...
* [ParanoidGuy Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,482 | 🐛 4 | 🌐 Go | 📅 2026-07-28 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA
...
* [faas](https://github.com/alexellis/faas) ⭐ 26,228 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - Run Docker containers as functions on Swarm Mode ([blog post](http://blog.alexellis.io/functions-as-a-service/))
...
* [Terraform AWS Lambda module](https://github.com/terraform-aws-modules/terraform-aws-lambda/) ⭐ 1,046 | 🐛 11 | 🌐 HCL | 📅 2026-08-06 - Terraform module, which takes care of a lot of AWS Lambda/serverless tasks (build dependencies, packages, updates, deployments) in countless combinations.
