...
* [Parse Server](https://parseplatform.org/) - Parse Server is an open source version of the Parse backend that can be deployed to any infrastructure that can run Node.js. You can find the source on the [GitHub repo](https://github.com/parse-community/parse-server) ⭐ 21,412 | 🐛 559 | 🌐 JavaScript | 📅 2026-09-13.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 37 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-14 - Serverless agentic AI operating system (h9y.ai). Open-source, self-hosted/cloud, omni-channel, decentralized, extensible.
...
* [Chalice](https://github.com/awslabs/chalice) ⭐ 11,058 | 🐛 495 | 🌐 Python | 📅 2026-09-11 - Python serverless microframework from Amazon for AWS lambda.
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,733 | 🐛 535 | 🌐 Python | 📅 2026-09-14 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,566 | 🐛 111 | 🌐 Python | 📅 2026-09-11
...
* [Lambda API](https://github.com/jeremydaly/lambda-api) ⭐ 1,469 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-13 - Lightweight web framework for your serverless applications.
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function) ⭐ 1,066 | 🐛 14 | 🌐 Java | 📅 2026-09-14 - Java framework for doing Functions using Spring ecosystem.
...
* [faas](https://github.com/alexellis/faas) ⭐ 26,241 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - Run Docker containers as functions on Swarm Mode ([blog post](http://blog.alexellis.io/functions-as-a-service/))
