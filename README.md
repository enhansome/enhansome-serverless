...
* [Parse Server](https://parseplatform.org/) - Parse Server is an open source version of the Parse backend that can be deployed to any infrastructure that can run Node.js. You can find the source on the [GitHub repo](https://github.com/parse-community/parse-server) ⭐ 21,412 | 🐛 553 | 🌐 JavaScript | 📅 2026-09-01.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 37 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31 - Serverless agentic AI operating system (h9y.ai). Open-source, self-hosted/cloud, omni-channel, decentralized, extensible.
...
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,732 | 🐛 543 | 🌐 Python | 📅 2026-09-01 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,563 | 🐛 115 | 🌐 Python | 📅 2026-08-25
...
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function) ⭐ 1,066 | 🐛 9 | 🌐 Java | 📅 2026-08-31 - Java framework for doing Functions using Spring ecosystem.
