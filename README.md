...
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,732 | 🐛 529 | 🌐 Python | 📅 2026-09-07 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,562 | 🐛 111 | 🌐 Python | 📅 2026-09-02
* [ClaudiaJS](https://github.com/claudiajs/claudia) ⭐ 3,884 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-03 - Deploy Node.js microservices to AWS easily.
...
* [Lambda API](https://github.com/jeremydaly/lambda-api) ⭐ 1,469 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-07 - Lightweight web framework for your serverless applications.
