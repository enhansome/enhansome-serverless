...
# :cloud: Awesome Serverless with stars
...
* [Parse Server](https://parseplatform.org/) - Parse Server is an open source version of the Parse backend that can be deployed to any infrastructure that can run Node.js. You can find the source on the [GitHub repo](https://github.com/parse-community/parse-server) ⭐ 21,413 | 🐛 549 | 🌐 JavaScript | 📅 2026-08-07.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-12 - Serverless agentic AI operating system (h9y.ai). Open-source, self-hosted/cloud, omni-channel, decentralized, extensible.
...
* [Tau](https://github.com/taubyte/tau) ⭐ 5,111 | 🐛 11 | 🌐 Go | 📅 2026-08-09 - Easily Build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [lychee.js](https://github.com/Artificial-Engineering/lycheejs) ⭐ 1 | 🐛 0 | 📅 2024-06-29 - Isomorphic adapters allow peer-to-peer event-graphed WebSockets and HTTP1.1, SPDY and HTTP2.0 sockets for node, node-sdl, html, html-nwjs and html-webview (both native and embedded).

## Frameworks

* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,823 | 🐛 686 | 🌐 Python | 📅 2023-03-23 - Serverless Python WSGI with AWS Lambda + API Gateway.
* [Chalice](https://github.com/awslabs/chalice) ⭐ 11,065 | 🐛 492 | 🌐 Python | 📅 2026-08-12 - Python serverless microframework from Amazon for AWS lambda.
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,727 | 🐛 532 | 🌐 Python | 📅 2026-08-14 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,563 | 🐛 121 | 🌐 Python | 📅 2026-08-13
...
* [Lambda API](https://github.com/jeremydaly/lambda-api) ⭐ 1,468 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-08 - Lightweight web framework for your serverless applications.
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function) ⭐ 1,065 | 🐛 11 | 🌐 Java | 📅 2026-08-13 - Java framework for doing Functions using Spring ecosystem.
...
* [Fission Workflows](https://github.com/fission/fission-workflows) ⭐ 380 | 🐛 62 | 🌐 Go | 📅 2023-03-30 - Fast workflow-based function composition for serverless functions.
...
* [Browser Functions](https://github.com/IBM/browser-functions) ⭐ 185 | 🐛 13 | 🌐 JavaScript | 📅 2025-09-17 - A lightweight serverless platform that uses Web Browsers as execution engines.
...
* [Mantil](https://github.com/mantil-io/mantil) ⭐ 114 | 🐛 4 | 🌐 Go | 📅 2022-11-07 - Golang serverless development kit for AWS Lambda. Tool for developers that removes ops work for them, not just another infrastructure tool.
* [CIM](https://github.com/thestackshack/cim) ⭐ 51 | 🐛 6 | 🌐 JavaScript | 📅 2019-03-25 - A CloudFormation first approach to AWS Lambdas.
* [FunctionShield](https://github.com/puresec/FunctionShield) ⭐ 40 | 🐛 0 | 📅 2019-10-29 - A security library that equips developers with the ability to easily enforce strict security controls on AWS Lambda function runtime by addressing 3 common use cases: 1) Disable outbound internet connectivity. 2) Disable read/write on the /tmp/ directory 3) Disable child process execution.
* [flowbject](https://github.com/alex20465/flowbject) ⚠️ Archived - A high-level library whose aim is to help with writing state-machine flows.
* [Lovage](https://github.com/CloudSnorkel/lovage) ⚠️ Archived - Python-only serverless framework that's more RPC-like and less HTTP service oriented.
* [lambda-restify](https://github.com/kksharma1618/lambda-restify) ⭐ 10 | 🐛 2 | 🌐 TypeScript | 📅 2018-08-10 - A restify/expressjs like interface for aws lamda with api gateway event.
* [Lambda Forest](https://github.com/tdsis/lambda-forest) ⭐ 2 | 🐛 3 | 🌐 Java | 📅 2018-10-08 - Microframework that makes it easier to develop REST API's using AWS Lambda Function and API Gateway.
* [lgw](https://github.com/ebridges/lgw) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2024-11-07 - Simply & easily configure an AWS Gateway & domain name in front of a Lambda.
* [Serverless Compose](https://github.com/DavidJFelix/serverless-compose) ⚠️ Archived - A lightweight, functional, composable, middleware framework for AWS lambda that stays out of the way.
...
* [Serverless Security Top 10 Guide](https://github.com/puresec/sas-top-10) ⭐ 339 | 🐛 1 | 📅 2019-10-24 - The Ten Most Critical Risks for Serverless Applications.
...
* [LambCI](https://github.com/lambci/lambci) ⭐ 3,963 | 🐛 41 | 🌐 Shell | 📅 2024-04-23 - A continuous integration system built on AWS Lambda
...
* [sls-dev-tools](https://github.com/Theodo-UK/sls-dev-tools) ⭐ 872 | 🐛 62 | 🌐 JavaScript | 📅 2023-04-25 - In terminal developer dashboard for AWS Serverless architectures. *(Does not replace your framework or logging/monitoring, it's used in addition)*
...
* [PureSec CLI](https://github.com/puresec/serverless-puresec-cli) ⭐ 250 | 🐛 7 | 🌐 JavaScript | 📅 2021-08-22 - Magically creates least privileged IAM roles for you.

## Payments

* [Stripe Lambda function](https://github.com/TaylorBriggs/stripe-lambda) ⭐ 160 | 🐛 1 | 🌐 JavaScript | 📅 2018-03-29 - A Lambda function for charging cards with Stripe.
* [Stripe Azure function](https://github.com/sdras/sample-stripe-handler) ⭐ 153 | 🐛 0 | 🌐 JavaScript | 📅 2017-12-05 - An Azure Function that uses the Stripe api for a checkout process in a Vue application
* [GCF-Stripe](https://github.com/rldaulton/GCF-Stripe) ⚠️ Archived - serverless use of Stripe over Google Cloud Functions.
* [Stripe Serverless webhook](https://github.com/eahefnawy/serverless-stripe-webhook) ⭐ 26 | 🐛 0 | 🌐 JavaScript | 📅 2015-12-12 - Serverless Module that creates a webhook for Stripe.
...
* [Serverless Mailer](https://github.com/eahefnawy/serverless-mailer) ⭐ 207 | 🐛 8 | 🌐 JavaScript | 📅 2018-06-25 - Serverless Module for sending emails.
* [Lambda Mailer](https://github.com/eahefnawy/lambda-mailer) ⭐ 128 | 🐛 4 | 🌐 JavaScript | 📅 2020-02-29 - AWS Lambda for sending emails.
* [Mailchimp Lambda](https://github.com/TaylorBriggs/mailchimp-lambda) ⭐ 44 | 🐛 1 | 🌐 JavaScript | 📅 2017-10-31 - A Lambda function for subscribing to a MailChimp list.
* [Mailchimp Lambda Single Opt-in](https://github.com/anaibol/lambda-mailchimp-single-opt-in) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2016-06-23 - An Amazon Lambda function for creating MailChimp subscriptions with single opt-in.

## SMS sending

* [serverless-twilio](https://github.com/eahefnawy/serverless-twilio) ⭐ 40 | 🐛 1 | 🌐 JavaScript | 📅 2015-12-12 - Serverless Module to send SMS via twilio.
...
* [ParanoidGuy Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,481 | 🐛 4 | 🌐 Go | 📅 2026-07-28 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA
...
* [faas](https://github.com/alexellis/faas) ⭐ 26,222 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - Run Docker containers as functions on Swarm Mode ([blog post](http://blog.alexellis.io/functions-as-a-service/))
...
* [Daggy](https://github.com/synacker/daggy) ⭐ 165 | 🐛 7 | 🌐 C++ | 📅 2026-07-26 - Data Aggregation Utility. Remote or local data aggregation and streaming
* [Backstage Functions](https://github.com/backstage/functions) ⭐ 49 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-04 - An Open Source Serverless Platform able to store and execute code maintained by [Globo.com](http://www.globo.com)
...
* [serverless.tf playground](https://github.com/antonbabenko/serverless.tf-playground) ⭐ 41 | 🐛 0 | 🌐 HCL | 📅 2026-02-05 - serverless.tf playground to show Terraform with Serverless in action.
* [FunctionCI](https://github.com/rgfindl/functionci) ⭐ 34 | 🐛 1 | 🌐 JavaScript | 📅 2018-02-13 - Continuous Integration for AWS Lambdas.
* [Mutton](https://github.com/hmngwy/mutton) ⭐ 17 | 🐛 8 | 🌐 Python | 📅 2022-12-08 - A Python shim library for better AWS Lambda Handlers
* [serverless-slack-webhook](https://github.com/eahefnawy/serverless-slack-webhook) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2015-12-12 - Serverless Module that creates a webhook for Slack.
* [Lambda Shim](https://github.com/ffleet/shim) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-08-10 - A node.js shim library to simplify Lambda function development
* [gofn](https://github.com/nuveo/gofn) ⚠️ Archived - Go package for function process via container provider (serverless minimalist)
...
* [Serverless Architectures Security Top 10](https://github.com/puresec/sas-top-10) ⭐ 339 | 🐛 1 | 📅 2019-10-24 - The Ten Most Critical Security Risks in Serverless Architectures.
