...
* [Parse Server](https://parseplatform.org/) - Parse Server is an open source version of the Parse backend that can be deployed to any infrastructure that can run Node.js. You can find the source on the [GitHub repo](https://github.com/parse-community/parse-server) ⭐ 21,411 | 🐛 553 | 🌐 JavaScript | 📅 2026-09-01.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 37 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-01 - Serverless agentic AI operating system (h9y.ai). Open-source, self-hosted/cloud, omni-channel, decentralized, extensible.
...
* [Chalice](https://github.com/awslabs/chalice) ⭐ 11,060 | 🐛 493 | 🌐 Python | 📅 2026-08-12 - Python serverless microframework from Amazon for AWS lambda.
* [SAM Local](https://github.com/awslabs/aws-sam-local) ⭐ 6,733 | 🐛 527 | 🌐 Python | 📅 2026-09-02 - Is the AWS CLI tool for managing Serverless applications written with [AWS Serverless Application Model (SAM)](https://github.com/awslabs/serverless-application-model) ⭐ 9,562 | 🐛 116 | 🌐 Python | 📅 2026-09-01
...
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function) ⭐ 1,066 | 🐛 7 | 🌐 Java | 📅 2026-09-01 - Java framework for doing Functions using Spring ecosystem.
...
* [Mantil](https://github.com/mantil-io/mantil) ⭐ 115 | 🐛 4 | 🌐 Go | 📅 2022-11-07 - Golang serverless development kit for AWS Lambda. Tool for developers that removes ops work for them, not just another infrastructure tool.
...
* [Stiva](https://github.com/anddimario/stiva) ⭐ 17 | 🐛 3 | 🌐 TypeScript | 📅 2023-01-24 - Stiva is a headless CMS for multisite and dynamic multicontent, based on lambda, dynamodb and s3.
...
* [Lambda Mailer](https://github.com/eahefnawy/lambda-mailer) ⭐ 126 | 🐛 4 | 🌐 JavaScript | 📅 2020-02-29 - AWS Lambda for sending emails.
...
* [ParanoidGuy Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,484 | 🐛 4 | 🌐 Go | 📅 2026-07-28 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA
...
* [faas](https://github.com/alexellis/faas) ⭐ 26,234 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - Run Docker containers as functions on Swarm Mode ([blog post](http://blog.alexellis.io/functions-as-a-service/))
...
* [Terraform AWS Lambda module](https://github.com/terraform-aws-modules/terraform-aws-lambda/) ⭐ 1,045 | 🐛 9 | 🌐 HCL | 📅 2026-08-06 - Terraform module, which takes care of a lot of AWS Lambda/serverless tasks (build dependencies, packages, updates, deployments) in countless combinations.
